...
namespace AwningsAPI.Interfaces
{
    public interface IWorkflowService
    {
        ...
        Task<List<Motors>> GeMotorsForProductAsync(int productId, int? armTypeId = null);
        Task<List<Control>> GetControlsForProductAsync(int productId);
        Task<bool> HasControlsAsync(int productId);
        Task<List<LightingCassette>> GetLightingForProductAsync(int productId);
        Task<bool> HasLightingAsync(int productId);
        ...
        Task<List<FrameColourOptionDto>> GetFrameColourOptionsAsync(int productId);
        Task<decimal> GetFrameColourPriceAsync(int productId, int frameColourOptionId, int widthCm);
